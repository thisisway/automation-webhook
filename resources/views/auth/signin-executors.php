            ...
            <div class="auth-form">
                <div class="card my-5">
                    <div class="card-body">
                        ...
                        <?php } ?>
                        <form action="/criar-conta-executor" method="POST">
                            ...
                            <h4 class="text-center mb-4">Cadastro de Executores</h4>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <select name="congregacoes[]" class="form-select" multiple required>
                                    <option value="999">Todas as congregações</option>
                                    <?php selectOptions($congregacoes, hasFlash('congregacoes'), 'id', 'nome') ?>
                                </select>
                                <?php displayError('congregacoes') ?>
                            </div>
